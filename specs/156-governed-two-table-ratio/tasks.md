# Tasks: Governed Two-Table Ratio Generation
...
- [ ] T005 Add RED template-contract tests, update the contract and variance templates, and regenerate their integration copies.
- [ ] T006 Run focused and full verification, record acceptance evidence, update c19's tracker state, and close the spec 156 fence.
