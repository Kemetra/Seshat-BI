...
_DISPATCH: dict[str, Callable[[object], int]] = {
    ...
    "tmdl-doc-comment-lint": _lazy(
        "..tmdl_doc_comment_lint", "tmdl_doc_comment_lint_main"
    ),
    ...
    "model-diff": _lazy(".commands.xray", "model_diff_main"),
    "reset": _lazy(".commands.reset", "reset_main"),
