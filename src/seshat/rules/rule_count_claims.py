...
SC2_REPORTS_ABSENCE = ReportsItsOwnAbsence(
    note=(
        "SC2 reports an absent rule-count-claims manifest as an ERROR naming "
        "the claims it could not reconcile"
    )
)
