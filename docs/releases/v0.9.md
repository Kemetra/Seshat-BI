...
**Two** additive surfaces sit on the MINOR row of
...
This note was authored proposing 0.9.0 on the strength of the additive surfaces
above; that proposal did not account for `1ac28b5`, which was found by external
review on the release PR (#622) after the fact. The
