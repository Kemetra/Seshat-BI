...
| RT-019 | "Help me with this." | Unknown / ambiguous | `COMPASS.md` → ask one clarifying question naming the missing input; if none can be named, emit the documented blocked verdict | clarifying question or blocked verdict | Do not route back and forth between `COMPASS.md` and `docs/knowledge-map.md`. | Not run |
